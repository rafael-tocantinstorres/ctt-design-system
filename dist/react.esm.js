...
const CttButton = forwardRef((props, ref) => {
...
const CttRadioButton = forwardRef((props, ref) => {
    const elementRef = useRef(null);
    useImperativeHandle(ref, () => elementRef.current);
    useEffect(() => {
        const element = elementRef.current;
...
const CttInputField = forwardRef((props, ref) => {
    const elementRef = useRef(null);
    useImperativeHandle(ref, () => elementRef.current);
    useEffect(() => {
        const element = elementRef.current;
...
const CttTextareaField = forwardRef((props, ref) => {
    const elementRef = useRef(null);
    useImperativeHandle(ref, () => elementRef.current);
    useEffect(() => {
        const element = elementRef.current;
...
const CttHeader = forwardRef((props, ref) => {
    const elementRef = useRef(null);
    useImperativeHandle(ref, () => elementRef.current);
    useEffect(() => {
        const element = elementRef.current;
...
const CttPage = forwardRef((props, ref) => {
    const elementRef = useRef(null);
    useImperativeHandle(ref, () => elementRef.current);
    useEffect(() => {
        const element = elementRef.current;
...
export { CttButton, CttHeader, CttInputField, CttPage, CttRadioButton, CttTextareaField };
